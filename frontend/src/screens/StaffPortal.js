...
function StaffPortal() {
  ...
  const requestRows = useMemo(() => classes
    ...
    .map((cls) => ({
      id: cls.id,
      parent: cls.parent?.fullName || cls.parent?.full_name || 'Phụ huynh',
