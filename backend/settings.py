...
# Database
# Mặc định dùng PostgreSQL khi chạy Docker. Nếu muốn chạy nhanh backend local
# không cần cài PostgreSQL, đặt USE_SQLITE=True rồi migrate/seed như bình thường.
